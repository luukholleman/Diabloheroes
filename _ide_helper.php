...
namespace {
	...
	class Search extends \Mmanos\Search\Facade{
		 ...
		 * @static 
		 */
		 public static function __construct($driver = null){
			//Method inherited from \Mmanos\Search\Search
			 \Mmanos\Search\Search::__construct($driver);
		 }
		 ...
		 */
		 public static function __call($method, $parameters){
			//Method inherited from \Mmanos\Search\Search
			return \Mmanos\Search\Search::__call($method, $parameters);
		 }
